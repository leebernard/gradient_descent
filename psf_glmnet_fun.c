...
#define __PYX_HAVE__psf_glmnet_fun
#define __PYX_HAVE_API__psf_glmnet_fun
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'psf_glmnet_fun' */
...
#define __Pyx_MODULE_NAME "psf_glmnet_fun"
extern int __pyx_module_is_main_psf_glmnet_fun;
int __pyx_module_is_main_psf_glmnet_fun = 0;

/* Implementation of 'psf_glmnet_fun' */
...
static const char __pyx_k_lam1i[] = "lam1i";
...
static const char __pyx_k_psf_glmnet_fun[] = "psf_glmnet_fun";
...
static const char __pyx_k_psf_glmnet_fun_pyx[] = "psf_glmnet_fun.pyx";
...
static PyObject *__pyx_n_s_lam1i;
...
static PyObject *__pyx_n_s_psf_glmnet_fun;
static PyObject *__pyx_kp_s_psf_glmnet_fun_pyx;
...
static PyObject *__pyx_pf_14psf_glmnet_fun_psf_glmnet_fun(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lambda_ar, __Pyx_memviewslice __pyx_v_psf2, __Pyx_memviewslice __pyx_v_c, __Pyx_memviewslice __pyx_v_beta, float __pyx_v_alpha); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_14psf_glmnet_fun_1psf_glmnet_fun(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_14psf_glmnet_fun_psf_glmnet_fun[] = " function to carry-out glmnet ";
static PyMethodDef __pyx_mdef_14psf_glmnet_fun_1psf_glmnet_fun = {"psf_glmnet_fun", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_14psf_glmnet_fun_1psf_glmnet_fun, METH_VARARGS|METH_KEYWORDS, __pyx_doc_14psf_glmnet_fun_psf_glmnet_fun};
static PyObject *__pyx_pw_14psf_glmnet_fun_1psf_glmnet_fun(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("psf_glmnet_fun (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_lambda_ar,&__pyx_n_s_psf2,&__pyx_n_s_c,&__pyx_n_s_beta,&__pyx_n_s_alpha,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_psf2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("psf_glmnet_fun", 1, 5, 5, 1); __PYX_ERR(0, 4, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("psf_glmnet_fun", 1, 5, 5, 2); __PYX_ERR(0, 4, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_beta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("psf_glmnet_fun", 1, 5, 5, 3); __PYX_ERR(0, 4, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("psf_glmnet_fun", 1, 5, 5, 4); __PYX_ERR(0, 4, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "psf_glmnet_fun") < 0)) __PYX_ERR(0, 4, __pyx_L3_error)
      }
    ...
    __pyx_v_lambda_ar = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_lambda_ar.memview)) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_psf2 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_float(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_psf2.memview)) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyObject_to_MemoryviewSlice_d_dc_float(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_c.memview)) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_beta = __Pyx_PyObject_to_MemoryviewSlice_d_dc_float(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_beta.memview)) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_alpha = __pyx_PyFloat_AsFloat(values[4]); if (unlikely((__pyx_v_alpha == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("psf_glmnet_fun", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("psf_glmnet_fun.psf_glmnet_fun", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14psf_glmnet_fun_psf_glmnet_fun(__pyx_self, __pyx_v_lambda_ar, __pyx_v_psf2, __pyx_v_c, __pyx_v_beta, __pyx_v_alpha);
...
static PyObject *__pyx_pf_14psf_glmnet_fun_psf_glmnet_fun(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_lambda_ar, __Pyx_memviewslice __pyx_v_psf2, __Pyx_memviewslice __pyx_v_c, __Pyx_memviewslice __pyx_v_beta, float __pyx_v_alpha) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("psf_glmnet_fun", 0);

  /* "psf_glmnet_fun.pyx":7
 *     """ function to carry-out glmnet """
 * 
 ...
 * 
 */
    __pyx_t_5 = (1.0 + ((1.0 - __pyx_v_alpha) * __pyx_v_lam));
    if (unlikely(__pyx_t_5 == 0)) {
      PyErr_SetString(PyExc_ZeroDivisionError, "float division");
      __PYX_ERR(0, 13, __pyx_L1_error)
    }
    __pyx_v_lam1i = (1. / __pyx_t_5);

    /* "psf_glmnet_fun.pyx":14
 *         lam = lambda_ar[k+1]
 *         lam1i = 1./(1 + (1-alpha)*lam)
 *         thresh = alpha*lam             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_thresh = (__pyx_v_alpha * __pyx_v_lam);

    /* "psf_glmnet_fun.pyx":16
 *         thresh = alpha*lam
 * 
 *         for ix in range(nx): # loop through psf's, one-at-a-time             # <<<<<<<<<<<<<<
 *             i1a = max(0,ix-sz1)
 ...
 *             for iy in range(ny):
 */
      __pyx_t_9 = (__pyx_v_ix - __pyx_v_sz1);
      __pyx_t_10 = 0;
      ...
      __pyx_v_i1a = __pyx_t_11;

      /* "psf_glmnet_fun.pyx":18
 *         for ix in range(nx): # loop through psf's, one-at-a-time
 *             i1a = max(0,ix-sz1)
 *             i1b = min(nx,ix+sz1+1)             # <<<<<<<<<<<<<<
 *             for iy in range(ny):
 ...
 */
      __pyx_t_11 = ((__pyx_v_ix + __pyx_v_sz1) + 1);
      ...
      __pyx_v_i1b = __pyx_t_13;

      /* "psf_glmnet_fun.pyx":19
 *             i1a = max(0,ix-sz1)
 *             i1b = min(nx,ix+sz1+1)
 *             for iy in range(ny):             # <<<<<<<<<<<<<<
 *                 if (c[ix,iy]<thresh): continue
 ...
 */
        ...
        __pyx_t_15 = (((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_c.data + __pyx_t_4 * __pyx_v_c.strides[0]) )) + __pyx_t_14)) ))) < __pyx_v_thresh) != 0);
        if (__pyx_t_15) {
          goto __pyx_L7_continue;
        }

        /* "psf_glmnet_fun.pyx":23
 * 
 *                 # otherwise adjust it's amplitude beta
 *                 dbeta = beta[ix,iy]             # <<<<<<<<<<<<<<
 ...
 */
        ...
        __pyx_v_dbeta = (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_14 * __pyx_v_beta.strides[0]) )) + __pyx_t_4)) )));

        /* "psf_glmnet_fun.pyx":24
 *                 # otherwise adjust it's amplitude beta
 *                 dbeta = beta[ix,iy]
 *                 alam = thresh-c[ix,iy]-dbeta             # <<<<<<<<<<<<<<
 *                 if (alam<0): dbeta += alam*lam1i
 ...
 */
        __pyx_t_4 = __pyx_v_ix;
        __pyx_t_14 = __pyx_v_iy;
        __pyx_v_alam = ((__pyx_v_thresh - (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_c.data + __pyx_t_4 * __pyx_v_c.strides[0]) )) + __pyx_t_14)) )))) - __pyx_v_dbeta);

        /* "psf_glmnet_fun.pyx":25
 *                 dbeta = beta[ix,iy]
 *                 alam = thresh-c[ix,iy]-dbeta
 *                 if (alam<0): dbeta += alam*lam1i             # <<<<<<<<<<<<<<
 *                 beta[ix,iy] -= dbeta
 * 
 */
        __pyx_t_15 = ((__pyx_v_alam < 0.0) != 0);
        if (__pyx_t_15) {
          __pyx_v_dbeta = (__pyx_v_dbeta + (__pyx_v_alam * __pyx_v_lam1i));
        }

        /* "psf_glmnet_fun.pyx":26
 *                 alam = thresh-c[ix,iy]-dbeta
 *                 if (alam<0): dbeta += alam*lam1i
 *                 beta[ix,iy] -= dbeta             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_14 = __pyx_v_ix;
        __pyx_t_4 = __pyx_v_iy;
        *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_14 * __pyx_v_beta.strides[0]) )) + __pyx_t_4)) )) -= __pyx_v_dbeta;

        /* "psf_glmnet_fun.pyx":28
 *                 beta[ix,iy] -= dbeta
 * 
 *                 j1a = max(0,iy-sz1)             # <<<<<<<<<<<<<<
 *                 j1b = min(ny,iy+sz1+1)
 *                 iy1 = iy+sz1
 */
        __pyx_t_16 = (__pyx_v_iy - __pyx_v_sz1);
        __pyx_t_11 = 0;
        if (((__pyx_t_16 > __pyx_t_11) != 0)) {
          __pyx_t_10 = __pyx_t_16;
        } else {
          __pyx_t_10 = __pyx_t_11;
        }
        __pyx_v_j1a = __pyx_t_10;

        /* "psf_glmnet_fun.pyx":29
 * 
 *                 j1a = max(0,iy-sz1)
 *                 j1b = min(ny,iy+sz1+1)             # <<<<<<<<<<<<<<
 *                 iy1 = iy+sz1
 * 
 */
        __pyx_t_10 = ((__pyx_v_iy + __pyx_v_sz1) + 1);
        ...
        __pyx_v_j1b = __pyx_t_18;

        /* "psf_glmnet_fun.pyx":30
 *                 j1a = max(0,iy-sz1)
 *                 j1b = min(ny,iy+sz1+1)
 *                 iy1 = iy+sz1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_v_iy1 = (__pyx_v_iy + __pyx_v_sz1);

        /* "psf_glmnet_fun.pyx":33
 * 
 *                 # correct c[i1,j1] for psf[ix,iy] impact at i1,j1
 ...
 */
        __pyx_t_16 = __pyx_v_i1b;
        __pyx_t_19 = __pyx_t_16;
        for (__pyx_t_20 = __pyx_v_i1a; __pyx_t_20 < __pyx_t_19; __pyx_t_20+=1) {
          __pyx_v_i1 = __pyx_t_20;

          /* "psf_glmnet_fun.pyx":34
 *                 # correct c[i1,j1] for psf[ix,iy] impact at i1,j1
 *                 for i1 in range(i1a,i1b):
 *                     ix1 = ix+sz1-i1             # <<<<<<<<<<<<<<
 *                     for j1 in range(j1a,j1b):
 ...
 */
          __pyx_v_ix1 = ((__pyx_v_ix + __pyx_v_sz1) - __pyx_v_i1);

          /* "psf_glmnet_fun.pyx":35
 *                 for i1 in range(i1a,i1b):
 *                     ix1 = ix+sz1-i1
 *                     for j1 in range(j1a,j1b):             # <<<<<<<<<<<<<<
 *                         c[i1,j1] += dbeta*psf2[ix1,iy1-j1]
 */
          __pyx_t_21 = __pyx_v_j1b;
          __pyx_t_22 = __pyx_t_21;
          for (__pyx_t_23 = __pyx_v_j1a; __pyx_t_23 < __pyx_t_22; __pyx_t_23+=1) {
            __pyx_v_j1 = __pyx_t_23;

            /* "psf_glmnet_fun.pyx":36
 *                     ix1 = ix+sz1-i1
 *                     for j1 in range(j1a,j1b):
 *                         c[i1,j1] += dbeta*psf2[ix1,iy1-j1]             # <<<<<<<<<<<<<<
 */
            __pyx_t_4 = __pyx_v_ix1;
            __pyx_t_14 = (__pyx_v_iy1 - __pyx_v_j1);
            __pyx_t_24 = __pyx_v_i1;
            __pyx_t_25 = __pyx_v_j1;
            *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_c.data + __pyx_t_24 * __pyx_v_c.strides[0]) )) + __pyx_t_25)) )) += (__pyx_v_dbeta * (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_psf2.data + __pyx_t_4 * __pyx_v_psf2.strides[0]) )) + __pyx_t_14)) ))));
          }
        }
        __pyx_L7_continue:;
      }
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "psf_glmnet_fun.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "psf_glmnet_fun._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_psf_glmnet_fun(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_psf_glmnet_fun},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_lam1i, __pyx_k_lam1i, sizeof(__pyx_k_lam1i), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_psf_glmnet_fun, __pyx_k_psf_glmnet_fun, sizeof(__pyx_k_psf_glmnet_fun), 0, 0, 1, 1},
  {&__pyx_kp_s_psf_glmnet_fun_pyx, __pyx_k_psf_glmnet_fun_pyx, sizeof(__pyx_k_psf_glmnet_fun_pyx), 0, 0, 1, 0},
 ...
 * 
 */
  __pyx_tuple__20 = PyTuple_Pack(26, __pyx_n_s_lambda_ar, __pyx_n_s_psf2, __pyx_n_s_c, __pyx_n_s_beta, __pyx_n_s_alpha, __pyx_n_s_nsteps, __pyx_n_s_sz, __pyx_n_s_nx, __pyx_n_s_ny, __pyx_n_s_k, __pyx_n_s_i1, __pyx_n_s_i1a, __pyx_n_s_i1b, __pyx_n_s_j1, __pyx_n_s_j1a, __pyx_n_s_j1b, __pyx_n_s_ix, __pyx_n_s_iy, __pyx_n_s_ix1, __pyx_n_s_iy1, __pyx_n_s_sz1, __pyx_n_s_dbeta, __pyx_n_s_alam, __pyx_n_s_lam, __pyx_n_s_lam1i, __pyx_n_s_thresh); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(5, 0, 26, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_psf_glmnet_fun_pyx, __pyx_n_s_psf_glmnet_fun, 4, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 4, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpsf_glmnet_fun(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initpsf_glmnet_fun(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_psf_glmnet_fun(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_psf_glmnet_fun(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_psf_glmnet_fun(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'psf_glmnet_fun' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_psf_glmnet_fun(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("psf_glmnet_fun", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_psf_glmnet_fun) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "psf_glmnet_fun")) {
      if (unlikely(PyDict_SetItemString(modules, "psf_glmnet_fun", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_14psf_glmnet_fun_1psf_glmnet_fun, NULL, __pyx_n_s_psf_glmnet_fun); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_psf_glmnet_fun, __pyx_t_1) < 0) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "psf_glmnet_fun.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * @cython.boundscheck(False)  # Deactivate bounds checking
 * @cython.wraparound(False)   # Deactivate negative indexing.
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init psf_glmnet_fun", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init psf_glmnet_fun");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
